...
import type {
    ...
    PurchaseItemPatch,
} from './components/purchase-items-table';
...
export default function PurchasesCreate({
    ...
    const selectedOutlet =
        outlets.find(
            (outlet) =>
                outlet.id.toString() === form.data.outlet_id,
        ) ?? null;
    ...
    const selectedSupplier =
        suppliers.find(
            (supplier) =>
                ...
                form.data.supplier_party_id,
        ) ?? null;

    const purchaseDate = parseDateValue(form.data.purchase_date);

    const paymentDate = parseDateValue(
        form.data.payment.payment_date,
    );
    ...
    const handlePurchaseItemChange = (
        ...
        form.setData((data) => ({
            ...data,
            items: data.items.map((purchaseItem) =>
                                ...
                                <SectionContent className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,22rem)]">
                                    <FieldGroup className="grid gap-4 md:grid-cols-3">
                                        ...
                                        <Field className="md:col-span-3">
                                            <FieldLabel htmlFor="payment_reference_no">
                                                Reference No
                                            </FieldLabel>
                                        ...
                                        <Field className="md:col-span-3">
                                            <FieldLabel htmlFor="payment_note">
                                                Payment Note
                                            </FieldLabel>
