...
export default function InventoryIndex({
    ...
    const query = (
        ...
        outlet_id:
            overrides.outlet_id ?? queryString.outlet_id ?? undefined,
        category_id:
        ...
        search:
            overrides.search === null
                ? undefined
                : (overrides.search ?? queryString.search ?? undefined),
        stock_status:
            overrides.stock_status ?? queryString.stock_status,
            ...
            <div className="px-4 py-6">
                <div className="mx-auto max-w-7xl space-y-8">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <Heading
                            title="Inventory"
                            description="Current stock is shown in each product's base unit."
                        />
                            ...
                            <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
                                ...
                                <div>
                                    <h2 className="font-semibold">
                                        No active outlet available
                                    </h2>

                                    <p className="mt-1 text-sm text-muted-foreground">
                                        Add or activate an outlet from Business
                                        settings to view inventory.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <>
                                ...
                                {summaryCards.map((card) => (
                                    ...
                                    >
                                        <CardContent className="flex items-center justify-between gap-4 px-5">
                                            ...
                                            <div
                                                className={`rounded-lg p-2.5 ${card.iconClassName}`}
                                            >
                            ...
                            <section className="space-y-4">
                                <div className="grid gap-3 lg:grid-cols-[minmax(16rem,1fr)_14rem_12rem_auto]">
                                    ...
                                    <Select
                                        value={
                                            queryString.category_id?.toString() ??
                                            'all'
                                        }
                                        onValueChange={(value) =>
                                            visit({
