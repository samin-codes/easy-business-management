...
class OpeningStockItem extends Model
{
    ...
    protected $fillable = [
        'opening_stock_id', 'product_variant_id', 'unit_of_measurement_id', 'product_unit_conversion_id',
        'quantity', 'base_quantity', 'unit_cost', 'base_unit_cost', 'total_cost', 'note',
    ];
    ...
    {
        return [
            'quantity' => 'decimal:4', 'base_quantity' => 'decimal:4', 'unit_cost' => 'decimal:2',
            'base_unit_cost' => 'decimal:6', 'total_cost' => 'decimal:2',
        ];
    }
