...
class StockAdjustmentItem extends Model
{
    ...
    protected $fillable = [
        'stock_adjustment_id', 'product_variant_id', 'unit_of_measurement_id', 'product_unit_conversion_id',
        'quantity', 'base_quantity', 'unit_cost', 'inventory_unit_cost', 'inventory_total_cost', 'note',
    ];
